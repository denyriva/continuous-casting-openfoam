...
#include "binaryAlloyMacrosegregation.H"
...
namespace solvers
{
    defineTypeNameAndDebug(binaryAlloyMacrosegregation, 0);
    addToRunTimeSelectionTable(solver, binaryAlloyMacrosegregation, fvMesh);
}
}
...
void Foam::solvers::binaryAlloyMacrosegregation::correctCoNum()
{
    basicFluidSolver::correctCoNum(phi);
}


void Foam::solvers::binaryAlloyMacrosegregation::continuityErrors()
{
    basicFluidSolver::continuityErrors(phi);
}


void Foam::solvers::binaryAlloyMacrosegregation::validateAlloyProperties() const
{
    if (rho_ <= SMALL)
    {
...
Foam::scalar
Foam::solvers::binaryAlloyMacrosegregation::updatePhaseState
(
    const bool report
)
{
...
void Foam::solvers::binaryAlloyMacrosegregation::updateBuoyancy()
{
...
void Foam::solvers::binaryAlloyMacrosegregation::updateBKCDrag
(
    const bool report
)
{
...
void Foam::solvers::binaryAlloyMacrosegregation::updateSpeciesDiagnostics
(
    const bool report
)
{
...
Foam::scalar
Foam::solvers::binaryAlloyMacrosegregation::solveSpeciesTransport()
{
...
void Foam::solvers::binaryAlloyMacrosegregation::updateEnergyDiagnostics() const
{
...
Foam::solvers::binaryAlloyMacrosegregation::binaryAlloyMacrosegregation
(
    fvMesh& mesh
)
:
    ...
    bkcDragAcceleration(bkcDragAcceleration_)
{
    ...
    Info<< "binaryAlloyMacrosegregation: species discretization" << nl
        << "    Eq. (19) advection = term-by-term" << nl
        << "    div(U*C)           = implicit" << nl
        << "    div(U*(Cl-C))      = explicit RHS correction"
        << endl;

    Info<< "binaryAlloyMacrosegregation: energy discretization" << nl
    ...
    Info<< "binaryAlloyMacrosegregation: alloy properties" << nl
        << "    rho             = " << rho_ << " kg/m3" << nl
...
void Foam::solvers::binaryAlloyMacrosegregation::preSolve()
{
...
void Foam::solvers::binaryAlloyMacrosegregation::prePredictor()
{}


void Foam::solvers::binaryAlloyMacrosegregation::momentumTransportPredictor()
{
    momentumTransport->predict();
}


void Foam::solvers::binaryAlloyMacrosegregation::
thermophysicalTransportPredictor()
{}


void Foam::solvers::binaryAlloyMacrosegregation::thermophysicalPredictor()
{
...
void Foam::solvers::binaryAlloyMacrosegregation::pressureCorrector()
{
...
void Foam::solvers::binaryAlloyMacrosegregation::momentumTransportCorrector()
{
    viscosity->correct();
...
void Foam::solvers::binaryAlloyMacrosegregation::postSolve()
{
    updateBKCDrag(true);
